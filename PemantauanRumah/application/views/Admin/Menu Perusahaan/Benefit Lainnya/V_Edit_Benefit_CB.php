<div class="modal-header">
    <h5 class="modal-title">Edit Benefit Company Branding</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form method="POST" class="d-flex flex-column" action="edit-BenefitCB" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="pl-2 mt-2 row">
                        <div class="col-sm-9">
                            <h5>Pilih Jurusan</h5>
                            <p> Jurusan yang sedang dipilih : </p>
                            <p> <?php echo $benefit[0]->V_jurusanTerlibat; ?> </p>
                            <?php
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control border" id="materiPublikasi" name="materiPublikasi"  value="<?php echo $benefit[0]->V_linkMateri; ?>">
                        </div>
                    </div>
                </div>
            </div>
